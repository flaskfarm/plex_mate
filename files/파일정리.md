...
def run(*args, **kwargs):
    ...
    # 단계, 섹션 ID, drytun, remove orphans
    page_show.task_interface('start4', '8', 'false', 'true').join()
    page_show.task_interface('start4', '9', 'false', 'true').join()
